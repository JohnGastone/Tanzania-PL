...
const F2 = ({navigation}) => {
    ...
    <View style={StyleSheet.container}>
            ...
            <View style={styles.fixtures}>
                {/* Fixture Date */}
                <View>
                    <Text style={{marginLeft: 165, marginBottom: 12, color: '#000000'}}>27 March</Text>
                </View>
                {/* Fixture */}
                <View style={styles.fixtureItem}>
                    ...
                    />
                    <Text style={{paddingLeft: 24, color:'#5C1919', alignSelf: 'center', marginLeft: -4}}>Simba Sc</Text>
