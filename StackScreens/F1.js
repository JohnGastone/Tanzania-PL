...
const F1 = ({navigation}) => {
    ...
    <View style={StyleSheet.container}>
            ...
            <View style={styles.fixtures}>
                {/* Fixture Date */}
                <View>
                    <Text style={{marginLeft: 167, marginBottom: 12, color: '#000000'}}>19 March</Text>
                </View>
                {/* Fixture */}
                <View style={styles.fixtureItem}>
                    <Text style={{paddingRight: 37, color:'#5C1919', alignSelf: 'center', marginRight: -25, marginLeft: 44 }}> Young Africans </Text>
                    <Button
                            title='16:00'
                            disabled={false}
                            color = '#3AA78D'
                    ...
                    />
                    <Text style={{paddingLeft: 24, color:'#5C1919', alignSelf: 'center', marginLeft: 8}}>KMC</Text>
