...
const Polisi = ({navigation}) => {
    ...
    <View style={StyleSheet.container}>
            ...
            <View style={styles.fixtures}>
                {/* Fixture Date */}
                <View>
                    <Text style={{paddingRight: 10,alignSelf: 'center', marginBottom: 12, color: '#000000'}}>1 April</Text>
                </View>
                {/* Result */}
                <View style={styles.fixtureItem}>
                    <Text style={{paddingRight: 29, color:'#5C1919', alignSelf: 'center', marginRight: -25, marginLeft: 44 }}> Polisi Tanzania </Text>
                    <Button
                            title=' 1 - 1 '
                            disabled={false}
                            color = '#3AA78D'
                    ...
                    />
                    <Text style={{paddingRight: 20, color:'#5C1919', alignSelf: 'center', marginLeft: 8}}>Ruvu Shooting</Text>
                ...
                <View style={styles.scorer}>
                    <Text style={styles.scorer1}>Tariq Seif, 6</Text>
                    <Text style={styles.scorer2}>84, Samson Joseph</Text>
                </View>
